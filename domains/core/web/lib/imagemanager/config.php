<?php
	...
	//$mcImageManagerConfig['filesystem.path'] = '../../content'; // absolute or relative from this script path, optional.
	$mcImageManagerConfig['filesystem.rootpath'] = '../../content'; // absolute or relative from this script path, required.
	...
	$mcImageManagerConfig['ExternalAuthenticator.secret_key'] = "hello123";
	*/
	
	$mcImageManagerConfig['authenticator'] = "GourdAuthenticator";
